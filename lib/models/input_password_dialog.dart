      ...
      actions: <Widget>[
        ...
        TextButton(
          ...
          onPressed: () async {
            ...
            try {
              // Call the backend to verify email and password
              final response = await http.post(
                Uri.parse('http://10.0.2.2:3000/api/verify-password'), // Backend URL
              ...
              if (response.statusCode == 200) {
                ...
                if (user == 'admin') {
                  ...
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => Support(email: inputEmail)),
                  );
                } else {
