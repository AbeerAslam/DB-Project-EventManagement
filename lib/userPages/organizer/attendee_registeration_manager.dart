...
class _OrganizerEventManagementState extends State<OrganizerEventManagement>
{
  ...
  Future<void> updateStatus(int attendeeId, int eventId, String eligibility, String registration) async
  {
    try {
        ...
        itemBuilder: (context, index) {
          ...
          return Card(
            child: ListTile(
              ...
              subtitle: Text("Event: ${attendee['eventId']}, Status: ${attendee['registration_status']}"),
              trailing: DropdownButton<String>(
                ...
                onChanged: (newStatus) {
                  if (newStatus != null) {
                    updateStatus(attendee['attendeeId'], attendee['eventId'], 'Eligible', newStatus);
                  }
                },
              ),
            ),
