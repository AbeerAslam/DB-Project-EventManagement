...
class CreateEventRequestScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(titleText: "Create Request", true, true).buildAppBar(),
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            // Submit Button
            ElevatedButton(
              style: ElevatedButton.styleFrom(backgroundColor: const Color.fromARGB(255, 16, 42, 67)),
              onPressed: () async {
                ...
                if (eventName.isEmpty || eventDay.isEmpty || capacity.isEmpty) {
                  ScaffoldMessenger.of(context).showSnackBar(
                    const SnackBar(content: Text("Event name, day, and capacity are required.")),
                  );
                  return;
                }
              ...
              child: const Text("Submit Request",style: const TextStyle(color: Colors.white)),
            ),
          ],
        ),
      ),
